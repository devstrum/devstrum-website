...
// CaseStudyPage - Devstrum Work page: featured case study + project index
// (backer's brand/production projects via House of Shafaq, AI systems shipped, and Ringg partner work)

const CASE = {
  tag: 'FEATURED CASE STUDY · LOGISTICS · MIDMARKET · 6 WEEKS',
  headline: ['We cut ops labour cost ', 'by ', ['64%', true], ' in one quarter.'],
  ...
  metrics: [['64%', 'labour cost ↓'], ['14→6', 'analyst hours/day'], ['$310K', 'annual savings']],
  ...
  return (
    <div style={{ background: bg, color: ink, fontFamily: '"Geist Mono", monospace', minHeight: '100%' }} data-screen-label="Work">
          ...
          <div>
            ...
            <div style={{ borderLeft: `2px solid ${accent}`, paddingLeft: 20, marginTop: 8 }}>
              <p style={{ fontFamily: '"Geist", sans-serif', fontSize: 17, fontWeight: 500, letterSpacing: '-0.01em', lineHeight: 1.45, margin: '0 0 10px', fontStyle: 'italic' }}>
                "This is exactly the kind of work I back Devstrum for - measurable, fast, no fluff."
              </p>
              <div style={{ fontSize: 12, color: muted, fontFamily: 'Inter, sans-serif' }}>Saad Mohammed · Founder, House of Shafaq · Devstrum supporter &amp; client</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ border: `2px solid ${ink}`, background: '#fafbfd', padding: 24, marginBottom: 32 }}>
              ...
              <svg viewBox="0 0 480 180" style={{ width: '100%' }}>
                ...
                <text x="194" y="32" fontSize="9" fontFamily="Geist Mono" fill={warm} letterSpacing="1">DEVSTRUM SHIPPED →</text>
              </svg>
      ...
      <section style={{ padding: `0 ${PAD_X} clamp(48px, 10vw, 96px)` }}>
        ...
        <h2 style={{ fontFamily: '"Geist", sans-serif', fontSize: 'clamp(24px, 5vw, 36px)', fontWeight: 600, letterSpacing: '-0.03em', margin: '0 0 12px' }}>The network behind us.</h2>
